...
class TurnoTest(unittest.TestCase):
    ...
    def test_generala_servida_3(self):
        turno = Turno()
        dados = turno.dados_lanzados
        dados._valores = [3,3,3,3,3]
        turno.dados_lanzados = dados
        self.assertTrue(turno.generala_servida())

    def test_generala_servida_2(self):
        turno = Turno()
        dados = turno.dados_lanzados
        dados._valores = [2,2,2,2,2]
        turno.dados_lanzados = dados
        self.assertTrue(turno.generala_servida())
...
class CalcularPuntosTest(unittest.TestCase):
    ...
    def test_calcular_puntos_full_punto_30(self):
        dados = [3, 3, 3, 2, 2]
        numero_lanzamiento = 2
        puntos = calcular_puntos(numero_lanzamiento, dados, "full")
        self.assertEqual(puntos, 30)
